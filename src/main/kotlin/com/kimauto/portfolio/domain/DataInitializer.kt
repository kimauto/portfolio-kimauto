...
@Component
@Profile(value = ["default"]) // profile이 default일떄만 등록해라
class DataInitializer(
    ...
    fun initializeData() {
        ...
        val links = mutableListOf<Link>(
            ...
            Link(name = "Linkedin", content = "https://www.linkedin.coEm/in/bokeunjeong", isActive = true),
        )
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(content = "Github Repository", url = "https://github.com/kimauto/portfolio-kimauto", isActive = true)
            )
        )
